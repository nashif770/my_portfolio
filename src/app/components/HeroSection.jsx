  ...
  return (
    <section className="grid grid-cols-1 sm:grid-cols-12">
      <div className="col-span-7 place-self-center text-center sm:text-left">
        ...
        <div>
          <button className="px-6 py-3 w-full sm:w-fit mr-4 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 mt-4 lg:m-0 bg-white hover:bg-slate-200 text-white">
            Hire Me
          </button>
