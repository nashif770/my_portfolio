...
import { CodeBracketIcon, CodeBracketSquareIcon } from "@heroicons/react/24/solid";
    ...
    <div>
      ...
      >
        <div className="overlay absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
          <Link href={"/"}>
            <CodeBracketSquareIcon  className="h-10 w-10 text-[#ADB7BE] m-2 cursor-pointer"></CodeBracketSquareIcon>
          </Link>
        </div>
      </div>
